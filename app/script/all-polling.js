...
var host = '1.1.1.1'
var port = 9092;
var syncInterval = 40000;
var p2pInterval = 150000;
var outInterval = 250000;
var sockets = {};
...
var init = function(host, port, uid, friends){
  ...
  var socket = io.connect(url,{secure:true, transports: ['xhr-polling'],'force new connection':true, reconnect:true, 'try multiple transports':false});
